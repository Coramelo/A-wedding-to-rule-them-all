function initMap() {
    var e = {
            lat: 40.51795049752537, 
            lng: -3.666947084656686
        },
...
$(document).ready(function() {
    ...
    var r = createCalendar({
        ...
        data: {
            title: "Boda de Alejandro y Saray",
            start: new Date("Mar 13, 2021 18:00"),
            end: new Date("Mar 14, 2021 02:00"),
            address: "La Borda del Mentidero, Alcobendas, Madrid",
            description: "No podemos esperar para veros en nuestro gran día. Para cualquier duda o problema, por favor ponte en contacto con Alejandro (+34 687307870)"
        }
    });
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        e.preventDefault();
        var t = $(this).serialize();
        $("#alert-wrapper").html(alert_markup("info", "<strong>¡Espera un momento!</strong> Estamos guardando los detalles.")), "b0e53b10c1f55ede516b240036b88f40" !== MD5($("#invite_code").val()) && "f516dfb84b9051ed85b89cdc3a8ab7f5" !== MD5($("#invite_code").val()) ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Lo siento!</strong> El código de invitación introducido no es correcto.")) : $.post("https://script.google.com/macros/s/AKfycbyosE-bNLhXoDguEJiCRKJkYhKBG1UxGoxRKrWmOaWxvas2fxd5/exec", t).done(function(e) {
            console.log(e), "error" === e.result ? $("#alert-wrapper").html(alert_markup("danger", e.message)) : ($("#alert-wrapper").html(""), $("#rsvp-modal").modal("show"))
        }).fail(function(e) {
            console.log(e), $("#alert-wrapper").html(alert_markup("danger", "<strong>Lo siento!</strong> Hay algún problema con el sevidor. "))
        })
    })
});
var MD5 = function(e) {
